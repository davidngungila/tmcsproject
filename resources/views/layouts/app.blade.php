      ...
      <div style="flex:1; padding: 8px 0;">
        ...
        <div class="nav-group">
          ...
          <div class="nav-dropdown {{ request()->is('communications*') || request()->is('api-configs*') ? 'show' : '' }}">
            <a href="{{ route('communications.create') }}" class="dropdown-item {{ request()->is('communications/create') ? 'active' : '' }}">Send Bulk SMS</a>
            <a href="{{ route('communications.index') }}" class="dropdown-item {{ request()->is('communications') ? 'active' : '' }}">History</a>
