...
@section('title', 'Group Meeting - ' . $group->name)
@section('page-title', 'Record Meeting: ' . $group->name)
@section('breadcrumb', 'Home / Group / Operations / Meeting')

@section('content')
<div class="animate-in">
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
        <!-- LEFT COLUMN: ATTENDANCE & CONTRIBUTIONS FORMS -->
        ...
        <!-- RIGHT COLUMN: COMBINED HISTORY -->
        <div class="lg:col-span-7">
            <div class="card border-none shadow-sm">
                <div class="card-header border-b p-6 bg-gray-50/50">
                    <h3 class="card-title text-xs font-black uppercase tracking-widest text-gray-400">Meeting History</h3>
                </div>
                <div class="table-wrap">
                    <table class="w-full">
                        ...
                        <tbody>
                            ...
                            @empty
                            <tr>
                                <td colspan="5" class="text-center py-16 text-muted italic">No meeting records found for this community.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
