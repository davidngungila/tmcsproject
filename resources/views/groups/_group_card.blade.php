<div class="card hover:shadow-xl transition-all duration-300 border border-gray-200 rounded-xl overflow-hidden">
  <div class="card-body p-5">
    ...
    <div class="bg-gray-50 rounded-lg p-3 mb-3 border border-gray-100">
      <div class="grid grid-cols-2 gap-2 text-xs">
        <div class="flex items-center gap-2">
          ...
          <span class="badge green text-xs">{{ ucfirst($group->type) }}</span>
        </div>
        <div class="flex items-center gap-2">
    ...
    <div class="flex gap-2">
      ...
      <a href="{{ route('groups.edit', $group->id) }}" class="btn btn-ghost btn-sm flex-1 hover:bg-green-50 hover:text-green-600 transition-colors">
