        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <div class="text-xs max-w-xs truncate" title="{{ strip_tags($template->content) }}">
                  {!! Str::limit(strip_tags($template->content), 60) !!}
                </div>
              </td>
              <td>
            ...
            <div class="flex gap-2">
              <a href="{{ route('message-templates.show', $template->id) }}" class="btn btn-secondary btn-sm p-1.5" title="View">
