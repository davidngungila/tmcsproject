  ...
  <form action="{{ route('members.store') }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="card-body">
        <div class="form-row">
          ...
          <div class="form-group">
            ...
            <input type="text" name="baptismal_name" class="form-control" value="{{ old('baptismal_name') }}">
        ...
        <div class="form-row">
          <div class="form-group">
            ...
            <select name="member_type" class="form-control" required>
              ...
              <option value="non-student" {{ old('member_type') == 'non-student' ? 'selected' : '' }}>Non-Student</option>
              <option value="employee" {{ old('member_type') == 'employee' ? 'selected' : '' }}>Employee</option>
              <option value="child" {{ old('member_type') == 'child' ? 'selected' : '' }}>Child</option>
            </select>
    ...
    <div class="card mb-4">
      <div class="card-header">
        ...
        <div class="card-subtitle">Upload member photo (optional)</div>
      </div>
      <div class="card-body">
    ...
    <div class="card mb-4">
      <div class="card-header">
        ...
        <div class="card-subtitle">Assign member to groups (optional)</div>
      </div>
      <div class="card-body">
        <div class="form-group">
          ...
          <div class="space-y-2">
            ...
            <label class="flex items-center gap-2 cursor-pointer">
              <input type="checkbox" name="groups[]" value="{{ $group->id }}" class="rounded" {{ in_array($group->id, old('groups', [])) ? 'checked' : '' }}>
  ...
  if (file) {
    ...
    reader.onload = function(e) {
      ...
      uploadBox.innerHTML = `
        ...
        <p style="font-size:14px;font-weight:600;color:var(--text-secondary);">Photo uploaded</p>
...
function removePhoto() {
  ...
  uploadBox.innerHTML = `
    ...
    <p style="font-size:12px;color:var(--text-muted);margin-top:4px;">JPG, PNG or GIF (MAX. 2MB)</p>
  `;
  uploadBox.onclick = function() { document.getElementById('photo').click(); };
}
</script>
@endpush
