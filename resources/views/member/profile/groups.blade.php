      ...
      <div class="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-amber-100">
        ...
        <div class="p-8 hover:bg-amber-50/10 transition-all">
          ...
          <div class="grid grid-cols-2 gap-3 mb-6">
            ...
            <a href="{{ route('groups.operations.meeting', $group->id) }}" class="flex flex-col items-center justify-center p-4 rounded-2xl bg-white border border-amber-100 hover:border-green-600 hover:shadow-md transition-all group">
