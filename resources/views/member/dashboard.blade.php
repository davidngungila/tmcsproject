            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-100">
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-2 gap-2 mb-4">
                        ...
                        <a href="{{ route('groups.operations.meeting', $group->id) }}" class="flex flex-col items-center justify-center p-3 rounded-xl bg-gray-50 hover:bg-green-50 transition-all group">
                            ...
                            <span class="text-[10px] font-bold mt-1 uppercase text-gray-600 group-hover:text-green-700">MEETING</span>
                        </a>
