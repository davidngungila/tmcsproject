...
<div class="animate-in max-w-5xl mx-auto">
    ...
    <div class="mb-6 p-4 bg-amber-50 border border-amber-200 rounded-2xl flex items-center gap-4 text-amber-800">
        ...
        <div>
            ...
            <p class="text-xs opacity-80">This contribution has been recorded but not yet verified. Accounting entries will be generated upon verification.</p>
        </div>
    </div>
    @else
    <div class="mb-6 p-4 bg-green-50 border border-green-200 rounded-2xl flex items-center gap-4 text-green-800">
        ...
        <div>
            <h4 class="font-bold text-sm">Contribution Verified</h4>
            <p class="text-xs opacity-80">This transaction has been verified and posted to the general ledger.</p>
        </div>
    </div>
    @endif
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="p-8">
                        ...
                        <div class="mb-10 flex items-center gap-6 p-6 bg-gray-50 rounded-3xl border border-gray-100">
                            ...
                            <div>
                                ...
                                <h3 class="text-lg font-black text-gray-900">{{ $contribution->member->full_name ?? 'Anonymous' }}</h3>
                                <p class="text-xs text-muted font-bold">{{ $contribution->member->registration_number ?? 'N/A' }}</p>
                            </div>
                        </div>
                        ...
                        <div class="mb-10">
                            <label class="text-[10px] text-muted uppercase font-black tracking-widest block mb-2">Internal Notes</label>
        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <div class="card p-6 text-center">
                <h4 class="text-[10px] font-black uppercase tracking-widest text-muted mb-6">Security Verification</h4>
                @php
                ...
                <p class="text-[10px] text-muted font-bold leading-relaxed px-4">Scan this code to instantly verify the authenticity of this receipt.</p>
            </div>
                ...
                <div class="space-y-6">
                    <div class="flex gap-4">
                        ...
                        <div>
                            ...
                            <div class="text-sm font-bold text-gray-900">{{ $contribution->recorder->name ?? 'System' }}</div>
                    ...
                    <div class="flex gap-4">
                        ...
                        <div>
                            ...
                            <div class="text-sm font-bold text-gray-900">{{ $contribution->verifier->name ?? 'System' }}</div>
                            <div class="text-[10px] text-muted italic mt-0.5">{{ $contribution->verified_at ? $contribution->verified_at->format('M d, Y \a\t h:i A') : 'N/A' }}</div>
                        </div>
                    </div>
                    @endif
                </div>
            ...
            <div class="card p-6">
                ...
                <div class="space-y-3">
                    ...
                    <a href="{{ route('finance.receipt', ['contribution' => $contribution->id]) }}" target="_blank" class="btn btn-secondary w-full py-4 rounded-2xl flex items-center justify-center gap-3 font-black text-xs">
                    ...
                    <a href="{{ route('finance.index') }}" class="btn btn-secondary w-full py-4 rounded-2xl flex items-center justify-center gap-3 font-black text-xs">
